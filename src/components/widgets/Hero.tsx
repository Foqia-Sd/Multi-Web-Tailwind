      ...
      <Wrapper>
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="flex-1">
            <h4 className="text-teal-700 font-semibold text-lg mt-4">Predential Initiative for Artificial Intelligence and Computing (PIAIC)</h4>
            <h1 className={`text-5xl sm:text-6xl font-bold`}>Certified Web 3.O and Metaverse Developer</h1>
